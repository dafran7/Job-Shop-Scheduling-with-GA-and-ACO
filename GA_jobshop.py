...
# Fungsi buat ekstrak data dari file "instances"
...
pt, ms, num_job, num_mc = extract_data("./instances/la02")
...
crossover_rate=float(input('Please input the size of Crossover Rate: ') or 0.7) # default value is 0.8
mutation_rate=float(input('Please input the size of Mutation Rate: ') or 0.1) # default value is 0.2
mutation_selection_rate=float(input('Please input the mutation selection rate: ') or 0.1)
num_mutation_jobs=round(num_gene*mutation_selection_rate)
num_iteration=int(input('Please input number of iteration: ') or 1500) # default value is 2000
    
start_time = time.time() # Buat menghitung waktu proses GA-nya sampai ketemu solusi yg optimal
...
#plt.show()
## Proses GA berhenti disini

### Kode" dibawah ini buat plot aja.. Nggk perlu dimengerti
'''--------plot gantt chart-------'''
import pandas as pd
